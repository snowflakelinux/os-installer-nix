...
SnowflakeOS is a NixOS based Linux distribution focused on beginner friendliness and ease of use. This repository contains Nix build files for [OS-Installer](https://gitlab.gnome.org/p3732/os-installer).

</div>

## How to run
```bash
nix run github:snowflakelinux/os-installer-nix
```
